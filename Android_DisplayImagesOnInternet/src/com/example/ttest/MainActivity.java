...
public class MainActivity extends Activity {  
    ...
    protected void onCreate(Bundle savedInstanceState) {  
        ...
        downImgBtn.setOnClickListener(new View.OnClickListener() {  
            ...
            public void onClick(View v) {  
                ...
                String imgUrl = "http://192.168.1.105:8080/weiboserver/photo/photo2.jpg";  
                new DownImgAsyncTask().execute(imgUrl,"http://192.168.1.105:8080/weiboserver/photo/photo3.jpg","http://192.168.1.105:8080/weiboserver/photo/photo4.jpg");  
            }  
        });  
    }  
    ...
    class DownImgAsyncTask extends AsyncTask<String, Void, Bitmap>{  
        ...
        protected Bitmap doInBackground(String... params) {  
            // TODO Auto-generated method stub  
            Bitmap b = getImageBitmap(params[2]);  
            return b;  
        }  
